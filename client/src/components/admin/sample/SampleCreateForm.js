...
import { Button, Form, Icon, Input, Message, Modal, TransitionablePortal } from 'semantic-ui-react'
          ...
          <Modal.Content>
            ...
            <Form onSubmit={this.props.onCreateSampleSubmit}>
              ...
              <Button positive icon type='submit' loading={newSample.loading}>
                <Icon name='file audio outline' />&nbsp;Create Sample
              </Button>
            </Form>
          </Modal.Content>
        </Modal>
...
export default connect(mapStateToProps, mapDispatchToProps)(SampleCreateForm)
