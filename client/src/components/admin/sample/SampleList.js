...
import { Icon, Loader, Message, Table, TransitionablePortal } from 'semantic-ui-react'

import './SampleList.css'
import { deleteSample, fetchSamples, resetDeletedSample } from '../../../actions/sample'
    ...
    return (
      <div>
        <Table celled>
          ...
          <Table.Body>
            {sampleList.samples.map(s => (<SampleListItem key={s.id} sample={s} />))}
          </Table.Body>
        </Table>
        ...
        >
          <Message warning style={{ left: '30%', position: 'fixed', top: '50%', zIndex: 1000 }}>
