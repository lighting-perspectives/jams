  ...
  render() {
    ...
    return (
      <List.Item>
        ...
        <List.Content>
          <List.Header as="h4">Instrument {instrument.label}</List.Header>
          <List.Description>
            Created: {instrument.createdAt} — Updated: {instrument.updatedAt}{" "}
            <br />
            Label: {instrument.label || "~"} <br />
            Uuid: {instrument.id} <br />
            <List.Header as="h5">
              <span style={{ marginRight: "1em" }}>Mappings</span>
