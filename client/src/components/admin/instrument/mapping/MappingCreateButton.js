  ...
  render() {
    return (
      <Button
        ...
        size="mini"
        disabled={
          this.props.newMapping.mapping &&
          this.props.newMapping.mapping.instrumentId === this.props.instrumentId
        }
        onClick={() =>
          this.props.createMappingOpenModal(this.props.instrumentId)
        }
      />
    )
  }
