  ...
  render () {
    ...
    return (
      <TransitionablePortal
        open={updatedInstrument.instrument !== null && updatedInstrument.updated}
      ...
      >
        ...
        >
          ...
          <Message.Content>
            The instrument {updatedInstrument.instrument ? ' n°' + updatedInstrument.instrument.id : ''} has been <strong>updated successfully</strong>
          </Message.Content>
        </Message>
      </TransitionablePortal>
    )
...
export default connect(mapStateToProps, mapDispatchToProps)(InstrumentUpdateSuccessMessage)
